...
in="$base_dir/loginsystem.djinni"

cpp_out="$base_dir/generated-src/cpp"
jni_out="$base_dir/generated-src/jni"
objc_out="$base_dir/generated-src/objc"
java_out="$base_dir/generated-src/java/com/dropbox/loginsystem"

java_package="com.dropbox.loginsystem"
...
"$base_dir/deps/djinni/src/run-assume-built" \
    ...
    --objc-swift-bridging-header "LoginSystem-Bridging-Header" \
    \
    --idl "$in"
